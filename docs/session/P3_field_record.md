# P3 formal-session field record

> Session code endpoint: `0e37f187d95db5f10cb6892cc2a97b543a5bd4eb`
>
...
- URL badge visually verified as `Participant: P3`: Yes / No
...
- Demo participant parameter: `DEMO_P3`
- Demo badge checked as `Participant: DEMO_P3`: Yes / No
- Demo doc ID: `6a6f8bd696018eb206d7eafc`
- Initial cluster count face-checked as `2`: Yes / No
- One confirm and one cross-cluster move demonstrated: Yes / No
- After demo, URL/badge changed back to `P3`: Yes / No
- First formal doc loaded only after the `P3` badge recheck: Yes / No

## Assigned documents and ID face-check

| Order | Document | Batch | doc_id | Clusters | Start | End | Recording running | ID checked by/time |
| --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| 1 | `P3_task1_batchC` | C | `6a6673f2aaaa46976afdb5f7` | 10 | | | | |
| 2 | `P3_task2_batchA` | A | `6a666f0d5f60ce182f69ff12` | 1 | | | | |
| 3 | `P3_task3_batchB` | B | `6a6625e3460dababa39a9be4` | 6 | | | | |
...
## Stage 2 qualitative coding — do not fill until all three sessions end

Allowed values: `observed`, `no spontaneous expression recorded`, `unclear`;
merge additionally uses preprinted `n/a` only when clusters = 1.

| Document | Clusters | Split | Merge | Navigation | Evidence timestamp(s) |
| --- | ---: | --- | --- | --- | --- |
| `P3_task1_batchC` | 10 | | | | |
| `P3_task2_batchA` | 1 | | **n/a (structurally unavailable)** | | |
| `P3_task3_batchB` | 6 | | | | |
