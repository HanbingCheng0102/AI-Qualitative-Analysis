# Formal-session paper records

This directory contains blank, version-controlled operational templates only.
...
- Do not add model names to the participant-facing materials. The researcher
  record uses task/document identity and cluster count; model identity is joined
